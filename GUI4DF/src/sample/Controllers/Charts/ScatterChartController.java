...
public class ScatterChartController {
    ...
    public ScatterChartController(ComboBox<String> cmbColNamesX,ComboBox<String> cmbColNamesY,ComboBox<Integer> additionalCountCmb,ScrollPane chartPane,ComboBox<String> inaCaseOfTwoCmb,
    ...
    public void showAlert(String mes) {
        ...
        alert.setHeaderText("Scatter Chart Drawer");
        alert.setContentText(mes);
        // alert.initModality(Modality.APPLICATION_MODAL);
        alert.showAndWait();
    }

    public void drawScatterChart(DataFrame df) {
        ...
        if (df.get(colNameX).zwrocObiekt(0) instanceof StringValue || df.get(colNameX).zwrocObiekt(0) instanceof DateTimeValue || df.get(colNameY).zwrocObiekt(0) instanceof StringValue || df.get(colNameY).zwrocObiekt(0) instanceof DateTimeValue) {
            ...
            if (additionalCountCmb.getSelectionModel().getSelectedIndex()== 0) {
                ...
                //creating the chart
                final javafx.scene.chart.ScatterChart<String, Number> scatterChart = new javafx.scene.chart.ScatterChart<>(xAxis, yAxis);

                scatterChart.setTitle("Wykres zależności " + colNameY + " od " + colNameX);
                ...
                chartPane.setContent(scatterChart);
